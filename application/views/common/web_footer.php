 <!-- Main Footer -->
 <footer class="main-footer" style="margin-left: 0px; padding-bottom: 40px">
   <div class="float-left d-none d-sm-inline-block">
     <strong class="">Copyright &copy; 2014-2021 <a href="https://adminlte.io">AdminLTE.io</a>.</strong>
     All rights reserved.
  </div>
...
<!-- OPTIONAL SCRIPTS -->
<script src="<?= ASSESTS_URL?>plugins/chart.js/Chart.min.js"></script>
<!-- AdminLTE for demo purposes -->
<!-- <script src="<?= ASSESTS_URL?>dist/js/demo.js"></script> -->
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?= ASSESTS_URL?>dist/js/pages/dashboard3.js"></script>
